...
let package = Package(
    ...
    dependencies: [
        ...
        // .package(url: "https://github.com/indice-co/Indice.Swift.Networking", .upToNextMinor(from: "1.3.0")),
        .package(path: "/Users/nikolaskonstantakopoulos/Projects/Platform/Indice.Swift.Networking"),
