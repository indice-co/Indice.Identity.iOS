...
public protocol AccountService: AnyObject {
    ...
    @available(*, renamed: "update(phone:otpChannel:)", message: "The async otpProvider is tricky too handle. Use the update(phone: String, otpChannel: TotpDeliveryChannel?) async throws -> (CallbackType.OtpResult) async throws -> () instead, to get an otp completion handler.")
    ...
    func confirmEmail(withToken token: String) async throws
