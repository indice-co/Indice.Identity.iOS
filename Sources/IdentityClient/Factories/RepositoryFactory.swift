...
public protocol RepositoryFactory {
    ...
    static func thisDeviceRepository(storage: ValueStorage, secureStorage: SecureStorage, currentDeviceInfoProvider: CurrentDeviceInfoProvider) -> ThisDeviceRepository
}
