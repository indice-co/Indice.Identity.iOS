...
![platform macOs 11](https://img.shields.io/badge/Platform-macOS%2011-blueviolet.svg)
...
```swift
dependencies: [
    .package(url: "https://github.com/indice-co/Indice.Identity.iOS", .upToNextMajor(from: "1.3.0"))
]
```
